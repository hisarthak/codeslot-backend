...
async function pullRepo() {
    ...
    try {
        ...
        const response = await axios.post("https://gitspace.duckdns.org:3002/repo/user/url/generate-urls", { keyNames: [s3LogsKey], theToken }, { headers: { "Content-Type": "application/json" } });
        ...
        const commitDataResponse = await axios.post("https://gitspace.duckdns.org:3002/repo/user/url/generate-urls", { keyNames: [commitDataKey] }, { headers: { "Content-Type": "application/json" } });
        ...
        const urlResponse = await axios.post("https://gitspace.duckdns.org:3002/repo/user/url/generate-urls", { keyNames: fileKeys }, { headers: { "Content-Type": "application/json" } });
